...
class Logger:
    ...
    def get_logs(self):
        return self.loss_train, self.acc_train, self.loss_val, self.acc_val
    
    def restore_logs(self, logs):
        self.loss_train, self.loss_val, self.acc_train, self.acc_val = logs
    
    def save_plt(self, model_save_dir):
        loss_path = os.path.join(model_save_dir, 'loss.jpg')
        acc_path = os.path.join(model_save_dir, 'acc.jpg')
